function WorkInProgress({ name }) {
  return <section className="dark:bg-dark">
    <section className="container mx-auto flex justify-center items-center p-12 h-[100vh] ">
      <article className="my-auto flex gap-6 flex-col dark:text-white">
